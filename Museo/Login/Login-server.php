...
if (isset($_POST['submitIn'])) {
  {
        ...
        if (strlen($_POST['email']) > 1 && strlen($_POST['contraseña']) > 1) {
            ...
            $Pedido = "select * from `login` where email = '" . $_POST["email"] . "' and contraseña = '" . $_POST["contraseña"] . "'"; //Inserta todos los datos a la base de datos
            //Se hace la conexion
            ...
            if (($row = mysqli_fetch_array($Resultado))) {
                ...
                if ($Resultado) { //verifica que los datos se envien a la base de datos
                    ...
                    header("location: ../museo/index.html"); //lo envia a la pagina de inicio
                } else {
